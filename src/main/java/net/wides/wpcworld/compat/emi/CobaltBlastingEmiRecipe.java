...
public class CobaltBlastingEmiRecipe implements EmiRecipe {

    private static final EmiTexture BACKGROUND =
            new EmiTexture(new Identifier(WPCWorld.MOD_ID,
                    "textures/gui/cobalt_blast_furnace_recipe_gui.png"),
                    0, 0, 176, 91);
    ...
    private final CobaltBlastingRecipe recipe;

    public CobaltBlastingEmiRecipe(CobaltBlastingRecipe recipe) {
        this.recipe = recipe;
    }

    @Override
    public EmiRecipeCategory getCategory() {
        return CobaltEmiCategories.COBALT_BLASTING;
    }
