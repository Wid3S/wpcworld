...
public class CobaltBlastingCategory implements DisplayCategory<BasicDisplay> {
    public static final Identifier TEXTURE =
            new Identifier(WPCWorld.MOD_ID, "textures/gui/cobalt_blast_furnace_recipe_gui.png");
    public static final CategoryIdentifier<FoundrySmeltingDisplay> COBALT_BLASTING =
            CategoryIdentifier.of(WPCWorld.MOD_ID, "cobalt_blasting");

    @Override
    public CategoryIdentifier<? extends BasicDisplay> getCategoryIdentifier() {
        return COBALT_BLASTING;
    }
    ...
    public Renderer getIcon() {
        return EntryStacks.of(ModBlocks.COBALT_BLAST_FURNACE.asItem().getDefaultStack());
    }
