...
public class FoundrySmeltingRecipeBuilder {
    ...
    private FoundrySmeltingRecipeBuilder(
            Ingredient input,
            int inputCount,
    ...
    public static FoundrySmeltingRecipeBuilder smelting(
        ...
        return new FoundrySmeltingRecipeBuilder(
    ...
    private class Provider implements RecipeJsonProvider {
        ...
        public void serialize(JsonObject json) {
            ...
            json.addProperty("type", WPCWorld.MOD_ID + ":" + FoundrySmeltingRecipe.Type.ID);
        ...
        public RecipeSerializer<?> getSerializer() {
            return FoundrySmeltingRecipe.Serializer.INSTANCE;
        }
