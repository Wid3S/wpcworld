...
public class FoundryFurnaceControllerScreenHandler extends ScreenHandler {

    private final Inventory inventory;
    private final net.minecraft.screen.PropertyDelegate propertyDelegate;

    public FoundryFurnaceControllerScreenHandler(int syncId, PlayerInventory inv, PacketByteBuf buf) {
        this(syncId, inv, (FoundryFurnaceControllerBlockEntity) inv.player.getWorld().getBlockEntity(buf.readBlockPos()));
    }

    public FoundryFurnaceControllerScreenHandler(int syncId, PlayerInventory playerInv, FoundryFurnaceControllerBlockEntity be) {
        super(ModScreenHandlers.FOUNDRY_FURNACE_CONTROLLER_SCREEN_HANDLER, syncId);
        this.inventory = be;
        ...
        addSlot(new Slot(inventory, 2, 104, 31) {
            ...
            public void onTakeItem(PlayerEntity player, ItemStack stack) {
                ...
                if (inventory instanceof FoundryFurnaceControllerBlockEntity be) {
