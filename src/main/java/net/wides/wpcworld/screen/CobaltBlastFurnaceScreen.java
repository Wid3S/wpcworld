...
public class CobaltBlastFurnaceScreen
        extends HandledScreen<CobaltBlastFurnaceScreenHandler> {

    private static final Identifier TEXTURE =
            new Identifier(WPCWorld.MOD_ID, "textures/gui/cobalt_blast_furnace_gui.png");
    ...
    public CobaltBlastFurnaceScreen(
            CobaltBlastFurnaceScreenHandler handler,
